...
public class BobTest {
	...
	public void talkingForcefully() {
		assertEquals("Whatever.", bob.hey("Hi there!"));
	}
	
	@Test
	public void usingAcronymsInRegularSpeech() {
		assertEquals("Whatever.", bob.hey("It's OK if you don't want to go work for NASA."));
	}
	
	@Test
	public void forcefulQuestions() {
		assertEquals("Calm down, I know what I'm doing!", bob.hey("WHAT'S GOING ON?"));
	}
	...
	public void shoutingWithNoExclamationMark() {
		assertEquals("Whoa, chill out!", bob.hey("I HATE THE DENTIST"));
	}
